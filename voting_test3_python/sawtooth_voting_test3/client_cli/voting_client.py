...
class Voting_Test3Client:
    def __init__(self, url, keyfile=None):
        ...
        if keyfile is not None:
            try:
                ...
                raise Voting_Test3ClientException(
    ...
    def _get_status(self, batch_id, wait):
        try:
            ...
            raise Voting_Test3ClientException(err)

    def _get_prefix(self):
        return _sha512('voting_test3'.encode('utf-8'))[0:6]
    ...
    def _send_request(self, suffix, data=None, content_type=None, name=None):
        ...
        try:
            ...
            if result.status_code == 404:
                raise Voting_Test3ClientException("No such key: {}".format(name))

            elif not result.ok:
                raise Voting_Test3ClientException("Error {}: {}".format(
