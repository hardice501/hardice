...
from sawtooth_voting.processor.handler import make_voting_address
...
def create_voting_transaction(verb, name, value, deps, signer):
    """Creates a signed voting transaction.
    ...
    Returns:
        transaction (transaction_pb2.Transaction): the signed voting
            transaction
    """
...
def add_create_batch_parser(subparsers, parent_parser):
    ...
    epilog = '''
    details:
     create sample batch(es) of voting transactions.
     populates state with voting key/value pairs
