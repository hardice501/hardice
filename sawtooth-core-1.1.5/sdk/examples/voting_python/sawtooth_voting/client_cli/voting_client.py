...
class VotingClient:
    ...
    def _get_status(self, batch_id, wait):
        try:
            ...
            raise VotingClientException(err)

    def _get_prefix(self):
        return _sha512('voting'.encode('utf-8'))[0:6]
    ...
    def _send_request(self, suffix, data=None, content_type=None, name=None):
        ...
        try:
            ...
            if result.status_code == 404:
                raise VotingClientException("No such key: {}".format(name))

            if not result.ok:
                raise VotingClientException("Error {}: {}".format(
